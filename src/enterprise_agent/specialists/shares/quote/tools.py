"""Alpha Vantage quote / tape tools."""
...
def get_daily_prices(symbol: str, last_n_days: int = 7) -> str:
    ...
    return compact_json({"meta": data.get("Meta Data"), "daily": {d: series[d] for d in dates}})
...
def get_tools():
    return [search_ticker, get_share_quote, get_daily_prices, get_share_news, get_market_movers]
